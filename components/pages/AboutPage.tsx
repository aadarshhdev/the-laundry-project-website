...
const TEAM = [
  { name: 'Arjun Kumar', role: 'Founder & CEO', initials: 'AK', bio: 'Passionate entrepreneur with 10+ years in the service industry. Built The Laundry Project to solve the laundry problem for busy urban professionals.', color: 'from-primary-600 to-primary-400' },
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.65 }} className="max-w-3xl">
            ...
            <p className="text-gray-300 text-lg leading-relaxed max-w-xl">
              The Laundry Project was built on a simple idea: everyone deserves clean, fresh clothes without the hassle. Today, we serve thousands of families across Indore with pride.
            </p>
          </motion.div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.65 }}>
              ...
              <h2 className="font-display font-bold text-3xl md:text-4xl text-secondary mb-6 leading-tight">
                From a Single Washing Machine to Indore's Most Trusted Laundry Service
              </h2>
              <div className="space-y-4 text-secondary-600 text-sm leading-relaxed">
                <p>
                  It started in 2019 with one washing machine, a van, and a big dream. Our founder Arjun Kumar noticed that busy professionals in Indore were spending precious weekend hours on laundry — time they could be spending with family or resting.
                </p>
                <p>
                  He launched The Laundry Project with a doorstep pickup model and a commitment to quality that would exceed expectations. Within six months, word spread across Geetabhawan and Scheme 140. Within a year, we had expanded to cover more neighbourhoods across the city.
                </p>
                <p>
                  Today, The Laundry Project processes thousands of orders every month, employs a dedicated team of fabric care specialists, and has earned the trust of families, working professionals, and businesses across Indore.
                </p>
              </div>
            </motion.div>
            ...
            <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.65 }}>
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  { emoji: '🏙️', label: 'Serving Indore', sub: 'Geetabhawan & Scheme No. 140' },
          ...
          <motion.div variants={stagger} initial="hidden" whileInView="visible" viewport={{ once: true, margin: '-80px' }} className="grid md:grid-cols-2 gap-8">
            ...
            <motion.div variants={fadeUp} className="bg-gradient-to-br from-primary-600 to-primary-700 rounded-2xl p-10 shadow-lg">
              ...
              <p className="text-primary-100 leading-relaxed text-sm">
                To become India's most trusted laundry and dry-cleaning brand — a household name synonymous with quality, convenience, and sustainability. We envision a future where every city in India benefits from The Laundry Project's service.
              </p>
            </motion.div>
          </motion.div>
        </div>
      ...
      <section className="py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div variants={stagger} initial="hidden" whileInView="visible" viewport={{ once: true, margin: '-80px' }} className="text-center mb-14">
            ...
            <motion.h2 variants={fadeUp} className="section-title">Why Choose The Laundry Project</motion.h2>
      ...
      <section className="py-24 bg-gradient-to-br from-primary-700 to-primary-900 relative overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            <h2 className="font-display font-bold text-4xl text-white mb-5">Experience The Difference</h2>
