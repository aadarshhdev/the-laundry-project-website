...
const TESTIMONIALS = [
  { name: 'Priya Sharma', role: 'Marketing Professional', rating: 5, text: 'The Real Project has been a lifesaver! My sarees and formal wear come back perfectly clean and pressed. The pickup service is incredibly convenient — I never have to step out.', initials: 'PS' },
...
const FAQS = [
  ...
  { q: 'Which areas do you service?', a: 'We currently cover Andheri, Bandra, Juhu, Powai, Goregaon, Malad, Kandivali, Borivali and surrounding Mumbai areas. More cities launching soon!' },
          ...
          <div className="grid lg:grid-cols-2 gap-14 items-center">
            ...
            <motion.div initial={{ opacity: 0, x: -40 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.7 }}>
              <motion.div
                ...
                className="inline-flex items-center gap-2 bg-primary-600/20 border border-primary-500/30 text-primary-300 text-xs font-semibold px-4 py-2 rounded-full mb-7 backdrop-blur-sm"
              >
                <span className="w-2 h-2 bg-accent-500 rounded-full animate-pulse" />
                Now serving Mumbai & surrounding areas
              </motion.div>
              ...
              <div className="flex flex-wrap gap-4 mb-10">
                ...
                <Link to="/pricing" className="border-2 border-white/25 text-white px-8 py-4 rounded-xl font-semibold text-base hover:bg-white/10 hover:-translate-y-0.5 transition-all duration-300">
                  View Pricing
                </Link>
              </div>
            ...
            {SERVICES.map(({ emoji, title, desc, price }) => (
              <motion.div key={title} variants={fadeUp} className="group p-8 rounded-2xl border border-gray-100 hover:border-primary-200 hover:bg-gradient-to-br hover:from-primary-50/50 hover:to-white card-hover">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Link to="/services" className="opacity-0 group-hover:opacity-100 transition-opacity text-primary-600 text-sm font-semibold flex items-center gap-1">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            ...
            <p className="text-primary-100 text-lg mb-10 max-w-xl mx-auto">
              Join thousands of happy customers who trust The Real Project for all their laundry needs.
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              <button onClick={openBooking} className="btn-white text-base px-8 py-4">
                Schedule Pickup Now
              </button>
              <Link to="/pricing" className="border-2 border-white/40 text-white px-8 py-4 rounded-xl font-semibold text-base hover:bg-white/10 hover:-translate-y-0.5 transition-all">
                View Pricing Plans
              </Link>
            </div>
          </motion.div>
