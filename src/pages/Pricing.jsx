...
const FAQS = [
  ...
  { q: 'Is there a free trial available?', a: 'Yes! Your first order with The Real Project comes with a 20% discount. Use code FIRST20 at checkout.' },
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <motion.p initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} transition={{ delay: 0.4 }} className="text-center text-secondary-400 text-sm mt-10">
            ...
            <Link to="/contact" className="text-primary-600 font-medium hover:underline">Custom enterprise plans available.</Link>
          </motion.p>
        </div>
      </section>
